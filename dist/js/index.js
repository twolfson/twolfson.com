...
hljs.LANGUAGES.yaml=function(hljs){return{contains:[hljs.APOS_STRING_MODE,hljs.QUOTE_STRING_MODE,hljs.HASH_COMMENT_MODE],keywords:{literal:'true false'},illegal:''};}(hljs);hljs.LANGUAGES.yaml=hljs.LANGUAGES.python;
